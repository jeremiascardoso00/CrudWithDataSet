    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Users] WHERE (([Id] = @Original_Id) AND ((@IsNull_firstName = 1 AND " +
                ...
                "ame = 1 AND [lastName] IS NULL) OR ([lastName] = @Original_lastName)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Users] ([Id], [firstName], [lastName]) VALUES (@Id, @firstName, @las" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Users] SET [Id] = @Id, [firstName] = @firstName, [lastName] = @lastName WHERE (([Id] = @Original_Id) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_lastName = 1 AND [lastName] IS NULL) OR ([lastName] = @Original_lastName)));
SELECT Id, firstName, lastName FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::practicaDB.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO [Users] ([firstName], [lastName]) VALUES (@firstName, @lastName);\r\n";
            ...
            this._commandCollection[3].CommandText = "SELECT        Id, firstName, lastName\r\nFROM            Users\r\nWHERE        (Id = " +
                "@id)";
            ...
            this._commandCollection[4].CommandText = "UPDATE [Users] SET [firstName] = @firstName, [lastName] = @lastName WHERE ([Id] =" +
                " @Id);";
        ...
        public virtual int FillBy(userDS.UsersDataTable dataTable, int id) {
        ...
        public virtual userDS.UsersDataTable GetDataById(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            userDS.UsersDataTable dataTable = new userDS.UsersDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual int Add(string firstName, string lastName) {
        ...
        public virtual int UpdateQuery(string firstName, string lastName, int Id) {
